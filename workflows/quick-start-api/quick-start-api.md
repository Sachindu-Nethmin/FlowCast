...
4. Select **Browse** and select the project location and select **Open**.
...
1. Select **Add Resource**, and select **GET** resource.
2. Set the resource path to `greeting` and select **Save**.
